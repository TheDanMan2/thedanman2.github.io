...
<head>
    ...
    <title>Общая очередь</title>
    <link rel="stylesheet" type="text/css" href="style.css">
</head>
<body>
    <div id="header">
        <h1 align="center" title="Общая очередь" > Общая очередь </h1>
